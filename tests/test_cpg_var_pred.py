...
from app.cpg_var_pred import app
...
class TestApp(unittest.TestCase):
    ...
    def test_prediction(self):
	    ...
	    input_sequence = 'ACTTATGTNTGGANNGCANATCGTACTAGGCGCTCGGNCGCGNGACTGCNCTNNTCTNACACCGTTCATAGANACCGANTCNNGAGGNCA'

	    # Expected target CpG count
	    expected_cpg_count = 7.0  # Update this with the expected target CpG count for the input sequence
